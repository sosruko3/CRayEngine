...
void cameraSystem_Update(EntityRegistry* reg, CommandBus* bus, float dt, ViewportSize vp);

CameraComponent cameraSystem_CreateDefault(void);

creRectangle cameraSystem_GetViewBounds(const EntityRegistry* reg, const CameraComponent* cam, ViewportSize vp);
